...
namespace pixel_pizzas
{
    public partial class nonveg : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            cmb.CommandText = "select Item_type,Item_name,price FROM menu where Item_type='nonveg'";
            cmb.ExecuteNonQuery();
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            SqlCommand cmb = con.CreateCommand();
            cmb.CommandType = CommandType.Text;
            cmb.CommandText = "INSERT INTO cart SELECT Item_name,price FROM menu where id=6";
            cmb.ExecuteNonQuery();
        ...
        con.Open();
            SqlCommand cmb = con.CreateCommand();
            cmb.CommandType = CommandType.Text;
            cmb.CommandText = "INSERT INTO cart SELECT Item_name,price FROM menu where id=7";
            cmb.ExecuteNonQuery();
        ...
        {con.Open();
            SqlCommand cmb = con.CreateCommand();
            cmb.CommandType = CommandType.Text;
            cmb.CommandText = "INSERT INTO cart SELECT Item_name,price FROM menu where id=8";
            cmb.ExecuteNonQuery();
        ...
        {con.Open();
            SqlCommand cmb = con.CreateCommand();
            cmb.CommandType = CommandType.Text;
            cmb.CommandText = "INSERT INTO cart SELECT Item_name,price FROM menu where id=9";
            cmb.ExecuteNonQuery();
        ...
        con.Open();
            SqlCommand cmb = con.CreateCommand();
            cmb.CommandType = CommandType.Text;
            cmb.CommandText = "INSERT INTO cart SELECT Item_name,price FROM menu where id=10";
            cmb.ExecuteNonQuery();
