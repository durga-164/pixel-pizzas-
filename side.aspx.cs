...
namespace pixel_pizzas
{
    public partial class side : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            cmb.CommandText = "select Item_type,Item_name,price FROM menu where Item_type='side'";
            cmb.ExecuteNonQuery();
               ...
               protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            SqlCommand cmb = con.CreateCommand();
            cmb.CommandType = CommandType.Text;
            cmb.CommandText = "INSERT INTO cart SELECT Item_name,price FROM menu where id=11";
            cmb.ExecuteNonQuery();
        ...
        con.Open();
            SqlCommand cmb = con.CreateCommand();
            cmb.CommandType = CommandType.Text;
            cmb.CommandText = "INSERT INTO cart SELECT Item_name,price FROM menu where id=12";
            cmb.ExecuteNonQuery();
        ...
        {con.Open();
            SqlCommand cmb = con.CreateCommand();
            cmb.CommandType = CommandType.Text;
            cmb.CommandText = "INSERT INTO cart SELECT Item_name,price FROM menu where id=13";
            cmb.ExecuteNonQuery();
        ...
        {con.Open();
            SqlCommand cmb = con.CreateCommand();
            cmb.CommandType = CommandType.Text;
            cmb.CommandText = "INSERT INTO cart SELECT Item_name,price FROM menu where id=14";
            cmb.ExecuteNonQuery();
        ...
        con.Open();
            SqlCommand cmb = con.CreateCommand();
            cmb.CommandType = CommandType.Text;
            cmb.CommandText = "INSERT INTO cart SELECT Item_name,price FROM menu where id=15";
            cmb.ExecuteNonQuery();
